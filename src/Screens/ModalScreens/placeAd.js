...
const PlaceAd = ({ navigation }) => {
    ...
    return (
        <ImageBackground source={require('../../Assests/Images/mapImage.png')} style={{ flex: 1 }}>
            <View style={containerStyles.container}>
                ...
                <View style={{ marginHorizontal: 25, marginTop: 15 }}>
                    {showImageIcon ? (
                        <TouchableOpacity style={{ justifyContent: "center", alignItems: 'center' }} onPress={openGallery}>
                            <ImageSelect name='image-size-select-actual' size={150} />
                        </TouchableOpacity>
                    ) : (
                        imagePath !== '' && (
                            <TouchableOpacity onPress={openGallery} style={{ justifyContent: 'center', alignItems: 'center' }}>
                                <Image source={{ uri: imagePath?.path }} style={{ height: 170, width: 200, borderRadius: 10 }} />
                            </TouchableOpacity>
                        )
                    )}


                    <InputField onChangeText={changedText => onChangeText(changedText, 'BusinessCategory')} placeholder={"Business Category"} />
                    <InputField onChangeText={changedText => onChangeText(changedText, 'AdTitle')} placeholder={"AdTitle"} />
                    <InputField onChangeText={changedText => onChangeText(changedText, 'AdDescription')} placeholder={"Ad Description"} />
